...
import type { Quiz, Question, BuildContextParams } from '@quizify/quiz-util'

const defaultParams: BuildContextParams = {
  minQuestions: 4,
  maxQuestions: 4,
  minAnswers: 4,
  maxAnswers: 4
...
export const fileContext = (params: BuildContextParams=defaultParams, addedContex="NO ADDITIONAL CONTEXT PROVIDED") => {
  return `
...
export const textContext = (params: BuildContextParams=defaultParams, addedContex="NO ADDITIONAL CONTEXT PROVIDED") => {
  return `
